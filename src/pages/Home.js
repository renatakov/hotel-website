      ...
      <>
        <div className={style.firstcontainer}>
          ...
          <button className={style.price}>
            <em>from</em> <strong>€3.200</strong> <em>per night</em>
          </button>
        </div>
        <section className={style.firstsection}>
          <h2 className={style.h2o2}>The Cabins</h2>
          <p className={style.po2p}>
          ...
          <img
            src="https://images.dwell.com/photos-6575684823601102848/6651420402502549504-large/the-bed-features-luxurious-supima-linen-and-woolen-blankets-as-well-as-hand-knit-pillows-from-a-local-artist.jpg"
            alt="lolololol"
            className={style.secimg}
          />
          <img
            src="https://cdn.archilovers.com/projects/b_730_b66affda-a307-4d28-b405-2a2b6477c8ae.jpg"
            alt="fera"
          ...
          />
          <img
            src="https://i2.wp.com/panoramaglasslodge.com/wp-content/uploads/2020/02/DJI_0762.jpg"
            alt="fero"
        ...
        <section className={style.section2}>
          ...
          <div className={style.pololo}>
            ...
            <p className={style.po5p}>
              ...
              there is a terrace, which is about nine meters above ground. The
              cottages are built around tall, old trees that go through the
        ...
        <section className={style.section4}>
          <img
            src="https://images.dwell.com/photos-6575684823601102848/6651420396669575168-large/the-cabins-overlook-the-hekla-volcano-one-of-icelands-most-active-volcanoes-it-is-part-of-a-25-mile-long-volcanic-ridge-and-during-the-middle-ages-it-was-referred-to-by-europeans-as-the-gateway-to-hell.jpg"
            alt="hohoho"
            className={style.hohoho}
          />
          <img
            src="https://mostuniquehotels.com/uploads/1024xNxunique-panorama-glass-lodge-iceland8.jpg.pagespeed.ic.dMoQ27aRIo.jpg"
            alt="hohoho"
            className={style.hoho}
          />
        ...
        <section className={style.sec5}>
          ...
          <img
            src="https://www.location-francophone.com/wp-content/uploads/2018/05/Le-lieu-id%C3%A9al-pour-observer-la-nature-%C2%A9-Panorama-Glass-Lodge.jpg"
            alt="ioioio"
            className={style.ioioio}
            width="214px"
            height="80px"
          />
          <button className={style.booknow2}>BOOK NOW</button>
          <button className={style.price1}>
            <em>from</em> <strong>€3.200</strong> <em>per night</em>
          </button>
        </section>
        <footer>
